...
func (RXWindow) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_as_aab4860cbc3fc684, []int{0}
}
...
func (ErrorType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_as_aab4860cbc3fc684, []int{1}
}
...
type HandleUplinkDataRequest struct {
	...
	// RX meta-data.
	RxInfo []*gw.UplinkRXInfo `protobuf:"bytes,7,rep,name=rx_info,json=rxInfo,proto3" json:"rx_info,omitempty"`
...
func (*HandleErrorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_aab4860cbc3fc684, []int{2}
}
...
func (*HandleDownlinkACKRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_aab4860cbc3fc684, []int{3}
}
...
func (*SetDeviceStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_as_aab4860cbc3fc684, []int{4}
}
...
func init() { proto.RegisterFile("as.proto", fileDescriptor_as_aab4860cbc3fc684) }

var fileDescriptor_as_aab4860cbc3fc684 = []byte{
	// 681 bytes of a gzipped FileDescriptorProto
	,
}
